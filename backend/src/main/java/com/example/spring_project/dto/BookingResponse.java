...
public class BookingResponse {
    ...
    public String         getRoomImgUrl()             { return roomImgUrl; }
    public void           setRoomImgUrl(String v)     { this.roomImgUrl = v; }
    public Double         getRoomPrice()              { return roomPrice; }
    public void           setRoomPrice(Double v)      { this.roomPrice = v; }
    public Integer        getRoomCapacity()           { return roomCapacity; }
    public void           setRoomCapacity(Integer v)  { this.roomCapacity = v; }
